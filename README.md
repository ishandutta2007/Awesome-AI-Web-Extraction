<p align="center">
  <img src="assets/banner.svg" alt="Awesome AI Web Extraction Banner" width="100%">
</p>
...
<p align="left">
  ...
  <a href="https://github.com/ishandutta2007/Awesome-AI-Web-Extraction"><img src="https://img.shields.io/github/stars/ishandutta2007/Awesome-AI-Web-Extraction?style=flat-square&color=gold" alt="Stars"/></a>
  <a href="https://github.com/ishandutta2007/Awesome-AI-Web-Extraction/network/members"><img src="https://img.shields.io/github/forks/ishandutta2007/Awesome-AI-Web-Extraction?style=flat-square&color=blue" alt="Forks"/></a>
  <a href="https://github.com/ishandutta2007/Awesome-AI-Web-Extraction/blob/main/LICENSE"><img src="https://img.shields.io/github/license/ishandutta2007/Awesome-AI-Web-Extraction?style=flat-square" alt="License"/></a>
...
| Project | Description | GitHub_Stars |
>>>>>>> ebaa0f55d1854f01ac3cedb5323c16930068ac2b
| :--- | :--- | :--- |
...
| 🦖 **[Firecrawl](https://github.com/mendableai/firecrawl)** | Turn any website into clean LLM-ready Markdown or structured data. Open-source & self-hostable. | [![Firecrawl Stars](https://img.shields.io/github/stars/mendableai/firecrawl?style=social&color=white)](https://github.com/mendableai/firecrawl/stargazers) |
| 🐍 **[Crawl4AI](https://github.com/unclecode/crawl4ai)** | #1 Open-Source LLM-friendly crawler. Asynchronous, output clean Markdown, structured extraction, dynamic JS rendering. | [![Crawl4AI Stars](https://img.shields.io/github/stars/unclecode/crawl4ai?style=social&color=white)](https://github.com/unclecode/crawl4ai/stargazers) |
| 🤖 **[ScrapeGraphAI](https://github.com/ScrapeGraphAI/Scrapegraph-ai)** | Python scraping library that uses LLM and direct graph pipelines to extract information from websites using natural language prompts. | [![ScrapeGraphAI Stars](https://img.shields.io/github/stars/ScrapeGraphAI/Scrapegraph-ai?style=social&color=white)](https://github.com/ScrapeGraphAI/Scrapegraph-ai/stargazers) |
| 🪓 **[Crawlee](https://github.com/apify/crawlee)** | Scalable web crawling and scraping library for Node.js / Python with automatic proxy management and headless browser support. | [![Crawlee Stars](https://img.shields.io/github/stars/apify/crawlee?style=social&color=white)](https://github.com/apify/crawlee/stargazers) |
| 🗡️ **[Katana](https://github.com/projectdiscovery/katana)** | High-performance next-generation web crawling and pipeline discovery framework in Go. | [![Katana Stars](https://img.shields.io/github/stars/projectdiscovery/katana?style=social&color=white)](https://github.com/projectdiscovery/katana/stargazers) |
| 🧩 **[Unstructured OS](https://github.com/Unstructured-IO/unstructured)** | Open-source core library for ingesting and processing unstructured documents (HTML, PDF, Word) into clean RAG vectors. | [![Unstructured OS Stars](https://img.shields.io/github/stars/Unstructured-IO/unstructured?style=social&color=white)](https://github.com/Unstructured-IO/unstructured/stargazers) |
| 📐 **[LLM Scraper](https://github.com/mishushakov/llm-scraper)** | TypeScript library to extract structured data from webpages using LLMs and Zod schemas. | [![LLM Scraper Stars](https://img.shields.io/github/stars/mishushakov/llm-scraper?style=social&color=white)](https://github.com/mishushakov/llm-scraper/stargazers) |
| 🤖 **[CyberScraper-2077](https://github.com/itsOwen/CyberScraper-2077)** | Open-source web scraper powered by LLMs (OpenAI, Gemini, Ollama) for schema-free web data extraction. | [![CyberScraper Stars](https://img.shields.io/github/stars/itsOwen/CyberScraper-2077?style=social&color=white)](https://github.com/itsOwen/CyberScraper-2077/stargazers) |
| 📝 **[Markdown Crawler](https://github.com/paulpierre/markdown-crawler)** | Multithreaded Python web crawler that recursively crawls websites and converts pages to Markdown for LLMs. | [![Markdown Crawler Stars](https://img.shields.io/github/stars/paulpierre/markdown-crawler?style=social&color=white)](https://github.com/paulpierre/markdown-crawler/stargazers) |
...
[![Star History Chart](https://star-history.dera.page/svg?repos=ishandutta2007/Awesome-AI-Web-Extraction&type=date&legend=top-left)](https://star-history.dera.page/#ishandutta2007/Awesome-AI-Web-Extraction&type=date&legend=top-left)
